...
@Profile("pagination")
@Component(TaskHandlerNames.WILD_FRUIT_DEDICATED_TASK_HANDLER)
class WildFruitPaginatedTaskHandler(
    override val transactionalTaskService: TransactionalPaginatedTaskService<DedicatedTaskState, OperationOnOrder, KafkaException>,
) : PaginatedTaskHandlerBase<DedicatedTaskState, OperationOnOrder>() {
