package io.scheduler.comparison.jobrunr.jobs.pagination.impl
...
class ListJobPaginator<T : JobState<*, ChunkedJobMetadata>, V> private constructor(
    ...
    private val pageExtractor: (pageSize: Int, jobState: T) -> List<V>,
) : JobPaginator<T, V> {

    data class Builder<T : JobState<*, ChunkedJobMetadata>, V>(
        var jobState: T,
        var pageExtractor: (pageSize: Int, jobState: T) -> List<V>,
    ) {
...
fun <T : JobState<*, ChunkedJobMetadata>, V> listJobPaginator(
    jobState: T,
    pageExtractor: (pageSize: Int, jobState: T) -> List<V>,
