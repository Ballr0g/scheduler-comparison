...
import io.scheduler.comparison.jobrunr.jobs.handlers.pagination.impl.WildFruitPaginatedJobHandler
...
class DedicatedWildFruitJobRequest(
    ...
    override fun getJobRequestHandler() = WildFruitPaginatedJobHandler::class.java
